...
PICS = (environ.get('PICS', 'https://envs.sh/rj9.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002436604488').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002340781909') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002223099829')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002340781909')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002436604488')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kfcinemas:kfcinemas11@cluster0.m8diz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "kfcinemas")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kfcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/kannadamoviereqst2025')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KC_BLOKBUSTER')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'KC_BLOKBUSTER') # Support Chat Link Without https:// or @
